...
try:
    model = torch.jit.load(f'{path}/model_rl.pth')
except:
    model = torch.jit.load(f'kaban/model_rl.pth')
model.eval()
...
def agent_rl(observation, configuration, calc_actions=True, stochastic_actions=False):
    global game_state
